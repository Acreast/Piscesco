...
namespace Piscesco.Views
{
    public class OrderListsController : Controller
    {
        ...
        public OrderListsController(PiscescoModelContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("OrderListID,ProductID,ProductImage,ProductName,ProductQuantity,TotalPrice,OrderID")] OrderList orderList)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OrderListID,ProductID,ProductImage,ProductName,ProductQuantity,TotalPrice,OrderID")] OrderList orderList)
        {
        ...
        {
            return _context.OrderList.Any(e => e.OrderListID == id);
        }
    }
}
